...
<div className="container-fluid px-4">
    <div className="row ">
        ...
        <NavLink  className="nav-link text-white fs-4 m-0 p-0"  activeStyle={{ fontWeight: "bold", color: "white" }}
                      exact
                      to={`/in/favorite`} >Favorites</NavLink>

        </div>
        <div className="col-2 d-flex align-items-center justify-content-center">
           
            <div className="text-break p-0 m-0 ">
...
></Route>
<Route path="/in/plans" render={props=>(<Plan token={this.state.token}></Plan>)} ></Route>
</div>
</div>
