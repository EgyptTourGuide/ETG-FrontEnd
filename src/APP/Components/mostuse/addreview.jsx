...
this.setState({error:"*Please answer all question"})
  ...
  hadelratechange=e=>{
    ...
    state[e.currentTarget.name] = e.currentTarget.value;}
        ...
        if(e.currentTarget.value==="true"){state.answers[e.currentTarget.name] = true;}
        else{
      ...
      <React.Fragment>
        ...
        <div id="review-form">
          ...
          <div className=" clos-con text-end mx-3 ">
            <span className="clo-icon" onClick={()=>this.props.closereview()}>
              ...
              <ul className="ul-rate p-0 m-0 text-center">
                <li className="p-0 m-0">
                  <input
                    ...
                    value={0}
                  />
                  <label htmlFor="radio0"  className="r-a rate-num  far fa-angry"></label>
                </li>
                <li>
                  <input
                    type="radio"
                    ...
                    value={1}
                  />
                  <label htmlFor="radio1"  className="r-as rate-num  far fa-meh-blank"></label>
                </li>
                <li>
                  <input
                    id="radio2"
                    ...
                    value={2}
                  />
                  <label htmlFor="radio2"  className="r-s rate-num  far fa-meh-rolling-eyes">
                ...
                <li>
                  <input
                    ...
                    value={3}
                  />
                  <label htmlFor="radio3" className="r-n rate-num  far fa-meh">
                ...
                <li>
                  ...
                  <label htmlFor="radio4" className="r-g rate-num  far fa-smile">
                ...
                <li>
                  <input
                    ...
                    value={5}
                  />
                  <label htmlFor="radio5"  className="r-h rate-num far fa-laugh-beam">
